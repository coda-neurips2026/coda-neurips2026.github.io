...
(function () {
  ...
  const members = [
    ...
    ["Yang Liu", "Huawei", "Reviewer"],
    ["Hossein Rajabzadeh", "Huawei", "Reviewer"],
    ["Rezaul Karim", "Huawei", "Reviewer"],
    ["Sandeep Gutta", "Huawei", "Reviewer"],
    ["Yihao Fang", "Huawei", "Reviewer"],
    ["Mohammad Mahdi Moradi", "Huawei", "Reviewer"],
    ["Austin Wen", "Huawei", "Reviewer"]
  ];
